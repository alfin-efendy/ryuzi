...
// To keep this file's mocks from leaking into the rest of the suite, we
// snapshot each module's real exports *before* installing the mock (a plain
// object spread, not a re-import — re-importing the same specifier later
// only sees the mocked registry entry), then restore that snapshot in
// `afterAll` so later test files in the same process see the genuine module
// again.
